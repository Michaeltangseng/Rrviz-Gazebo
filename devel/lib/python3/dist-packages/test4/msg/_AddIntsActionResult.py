...
"""autogenerated by genpy from test4/AddIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionResult(genpy.Message):
  ...
  _type = "test4/AddIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test4/AddIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = test4.msg.AddIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = test4.msg.AddIntsResult()
