...
"""autogenerated by genpy from test4/AddIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddIntsActionFeedback(genpy.Message):
  ...
  _type = "test4/AddIntsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test4/AddIntsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = test4.msg.AddIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = test4.msg.AddIntsFeedback()
