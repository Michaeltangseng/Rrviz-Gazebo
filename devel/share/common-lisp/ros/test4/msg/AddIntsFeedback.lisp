...
(cl:defmethod cl:initialize-instance :after ((m <AddIntsFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddIntsFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test4-msg:<AddIntsFeedback> is deprecated: use test4-msg:AddIntsFeedback instead.")))

(cl:ensure-generic-function 'progress_bar-val :lambda-list '(m))
(cl:defmethod progress_bar-val ((m <AddIntsFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test4-msg:progress_bar-val is deprecated.  Use test4-msg:progress_bar instead.")
  (progress_bar m))
